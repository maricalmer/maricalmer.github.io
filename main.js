...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_default, "targets", ["button", "link"]);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(_default, [{
    ...
    value: function fetchMovies(query) {
      ...
      fetch("http://www.omdbapi.com/?s=".concat(query, "&apikey=adf1f2d7")).then(function (response) {
        ...
        return _this.insertMovies(data);
      });
    }
  }, {
    key: "insertMovies",
    value: function insertMovies(data) {
      ...
      data.Search.forEach(function (result) {
        ...
        _this2.resultsTarget.insertAdjacentHTML("beforeend", movieTag);
      });
    }
  }, {
    key: "search",
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_5___default()(_default, "targets", ["input", "results"]);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(_default, [{
    ...
    value: function connect() {
      ...
      sortablejs__WEBPACK_IMPORTED_MODULE_6__["default"].create(this.element, {
        ghostClass: "ghost",
        animation: 3000,
